...
class GMail( BaseMail ):
    def __init__( self, sender, pwd ):
        BaseMail.__init__( self, 'smtp22.gmail.com', True, sender, pwd )
...
class gexingServiceMail( BaseMail ):
    def __init__( self, sender, pwd ):
        BaseMail.__init__( self, 'service22.gexing.com', True, sender, pwd )
        self.__strcode = 'utf-8'
...
class Com63Mail( BaseMail ):
    def __init__( self, sender, pwd ):
        BaseMail.__init__( self, 'smtp22.163.com', False, sender, pwd )
        self.__strcode = 'utf-8'
